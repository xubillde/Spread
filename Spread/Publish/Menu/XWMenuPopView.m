...
-(void)setUpView{
    ...
    _backgroundView.backgroundColor = [UIColor colorWithRed:61/255.0 green:77/255.0 blue:100/255.0 alpha:0.9];
...
-(void)clickMenu:(UIButton *)button{
    ...
    if (_menuPopDelegate && [_menuPopDelegate respondsToSelector:@selector(XWMenuPopView:didSelectedMenuIndex:)]) {
        [self hideMenuViewTop];
        [_menuPopDelegate XWMenuPopView:self didSelectedMenuIndex:selectedIndex];
    }
}
