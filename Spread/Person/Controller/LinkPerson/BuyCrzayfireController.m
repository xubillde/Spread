...
@interface BuyCrzayfireController ()<WKNavigationDelegate>{
    //蒙版
    MBProgressHUD *_MB;
}
//网页
...
@implementation BuyCrzayfireController

#pragma mark - 懒加载
-(WKWebView *)WKWebView{
    if (_WKWebView == nil) {
        _WKWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight-64)];
        self.link = @"https://izhongchou.taobao.com/dreamdetail.htm?spm=0.0.0.0.ArXPhB&id=10063611&";
